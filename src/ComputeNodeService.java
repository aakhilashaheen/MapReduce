...
public class ComputeNodeService {
  ...
  public interface Iface {
    ...
    public String mapTask(String inputFilename) throws org.apache.thrift.TException;

    public String sortTask(List<String> intermediateFilenames) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void sortTask(List<String> intermediateFilenames, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String sortTask(List<String> intermediateFilenames) throws org.apache.thrift.TException
    {
      send_sortTask(intermediateFilenames);
      return recv_sortTask();
    }

    public void send_sortTask(List<String> intermediateFilenames) throws org.apache.thrift.TException
    {
      sortTask_args args = new sortTask_args();
      args.setIntermediateFilenames(intermediateFilenames);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sortTask(List<String> intermediateFilenames, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sortTask_call method_call = new sortTask_call(intermediateFilenames, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class sortTask_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<String> intermediateFilenames;
      public sortTask_call(List<String> intermediateFilenames, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sortTask<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sortTask_args> {
      ...
      public sortTask_result getResult(I iface, sortTask_args args) throws org.apache.thrift.TException {
        sortTask_result result = new sortTask_result();
        result.success = iface.sortTask(args.intermediateFilenames);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sortTask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sortTask_args, String> {
      ...
      public void start(I iface, sortTask_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.sortTask(args.intermediateFilenames,resultHandler);
      }
    }
  ...
  public static class sortTask_args implements org.apache.thrift.TBase<sortTask_args, sortTask_args._Fields>, java.io.Serializable, Cloneable, Comparable<sortTask_args>   {
    ...
    private static final org.apache.thrift.protocol.TField INTERMEDIATE_FILENAMES_FIELD_DESC = new org.apache.thrift.protocol.TField("intermediateFilenames", org.apache.thrift.protocol.TType.LIST, (short)1);
    ...
    public List<String> intermediateFilenames; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      INTERMEDIATE_FILENAMES((short)1, "intermediateFilenames");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // INTERMEDIATE_FILENAMES
            return INTERMEDIATE_FILENAMES;
          default:
            return null;
        }
      }
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.INTERMEDIATE_FILENAMES, new org.apache.thrift.meta_data.FieldMetaData("intermediateFilenames", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public sortTask_args(
      List<String> intermediateFilenames)
    {
      this();
      this.intermediateFilenames = intermediateFilenames;
    }
    ...
    public sortTask_args(sortTask_args other) {
      if (other.isSetIntermediateFilenames()) {
        List<String> __this__intermediateFilenames = new ArrayList<String>(other.intermediateFilenames);
        this.intermediateFilenames = __this__intermediateFilenames;
      }
    }
    ...
    @Override
    public void clear() {
      this.intermediateFilenames = null;
    }

    public int getIntermediateFilenamesSize() {
      return (this.intermediateFilenames == null) ? 0 : this.intermediateFilenames.size();
    }

    public java.util.Iterator<String> getIntermediateFilenamesIterator() {
      return (this.intermediateFilenames == null) ? null : this.intermediateFilenames.iterator();
    }

    public void addToIntermediateFilenames(String elem) {
      if (this.intermediateFilenames == null) {
        this.intermediateFilenames = new ArrayList<String>();
      }
      this.intermediateFilenames.add(elem);
    }

    public List<String> getIntermediateFilenames() {
      return this.intermediateFilenames;
    }

    public sortTask_args setIntermediateFilenames(List<String> intermediateFilenames) {
      this.intermediateFilenames = intermediateFilenames;
      return this;
    }

    public void unsetIntermediateFilenames() {
      this.intermediateFilenames = null;
    }

    /** Returns true if field intermediateFilenames is set (has been assigned a value) and false otherwise */
    public boolean isSetIntermediateFilenames() {
      return this.intermediateFilenames != null;
    }

    public void setIntermediateFilenamesIsSet(boolean value) {
      if (!value) {
        this.intermediateFilenames = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case INTERMEDIATE_FILENAMES:
        if (value == null) {
          unsetIntermediateFilenames();
        } else {
          setIntermediateFilenames((List<String>)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case INTERMEDIATE_FILENAMES:
        return getIntermediateFilenames();
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case INTERMEDIATE_FILENAMES:
        return isSetIntermediateFilenames();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(sortTask_args that) {
      ...
      boolean this_present_intermediateFilenames = true && this.isSetIntermediateFilenames();
      boolean that_present_intermediateFilenames = true && that.isSetIntermediateFilenames();
      if (this_present_intermediateFilenames || that_present_intermediateFilenames) {
        if (!(this_present_intermediateFilenames && that_present_intermediateFilenames))
          return false;
        if (!this.intermediateFilenames.equals(that.intermediateFilenames))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_intermediateFilenames = true && (isSetIntermediateFilenames());
      list.add(present_intermediateFilenames);
      if (present_intermediateFilenames)
        list.add(intermediateFilenames);
    ...
    public int compareTo(sortTask_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetIntermediateFilenames()).compareTo(other.isSetIntermediateFilenames());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetIntermediateFilenames()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.intermediateFilenames, other.intermediateFilenames);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("intermediateFilenames:");
      if (this.intermediateFilenames == null) {
        sb.append("null");
      } else {
        sb.append(this.intermediateFilenames);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class sortTask_argsStandardScheme extends StandardScheme<sortTask_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.intermediateFilenames = new ArrayList<String>(_list0.size);
                  String _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = iprot.readString();
                    struct.intermediateFilenames.add(_elem1);
                  }
                  iprot.readListEnd();
                }
                struct.setIntermediateFilenamesIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sortTask_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.intermediateFilenames != null) {
          oprot.writeFieldBegin(INTERMEDIATE_FILENAMES_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.intermediateFilenames.size()));
            for (String _iter3 : struct.intermediateFilenames)
            {
    ...
    private static class sortTask_argsTupleScheme extends TupleScheme<sortTask_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, sortTask_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetIntermediateFilenames()) {
          optionals.set(0);
        }
        oprot.writeBitSet(optionals, 1);
        if (struct.isSetIntermediateFilenames()) {
          {
            oprot.writeI32(struct.intermediateFilenames.size());
            for (String _iter4 : struct.intermediateFilenames)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.intermediateFilenames = new ArrayList<String>(_list5.size);
            String _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = iprot.readString();
              struct.intermediateFilenames.add(_elem6);
            }
          }
          struct.setIntermediateFilenamesIsSet(true);
        }
